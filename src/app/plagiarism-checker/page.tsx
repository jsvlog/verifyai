          ...
          {state !== 'done' ? (
            <div className="max-w-[740px] mx-auto text-center">
              <div className="mb-10 animate-fade-in-up">
                ...
                <p className="text-lg text-[#8c7a64] max-w-xl mx-auto text-center">Scan your text against web sources to ensure it&apos;s 100% original.</p>
                <div className="flex flex-wrap justify-center gap-2.5 mt-6">
                  {['🌐 Web sources', '📊 Similarity score', '🔗 Source links'].map((f) => (
              ...
              {gateError === 'premium' && (
                <div className="animate-scale-in p-8 bg-white rounded-3xl border border-[#ffa94d] shadow-xl shadow-[#3d3227]/6 mb-6">
                  ...
                  <p className="text-sm text-[#8c7a64] mb-6">Plagiarism Checker is available on all paid plans. Upgrade to unlock.</p>
